-- Remover triggers e funções antigas com CASCADE
DROP TRIGGER IF EXISTS on_ticket_created_email ON tickets CASCADE;
DROP TRIGGER IF EXISTS on_ticket_status_changed_email ON tickets CASCADE;
DROP TRIGGER IF EXISTS on_new_message_email ON ticket_messages CASCADE;
