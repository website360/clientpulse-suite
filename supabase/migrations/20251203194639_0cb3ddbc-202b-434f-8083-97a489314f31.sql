-- Reverter a RPC para NÃO marcar whatsapp_sent automaticamente
-- Deixar o trigger trg_update_exec_whatsapp_status cuidar disso quando o log for salvo
...
BEGIN
  ...
  -- Inserir execução de manutenção (inicialmente FALSE - será atualizado pelo trigger quando o log for salvo)
  ...
  -- O trigger trg_update_exec_whatsapp_status vai atualizar whatsapp_sent quando o log for salvo
  ...
  -- NÃO marcar whatsapp_sent aqui!
  -- O trigger vai cuidar disso quando o log de notificação for salvo com sucesso
