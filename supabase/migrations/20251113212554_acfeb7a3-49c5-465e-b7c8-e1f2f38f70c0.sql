-- Corrigir RPC para marcar WhatsApp como enviado após o envio
...
BEGIN
  ...
  -- Montar checklist formatado NA ORDEM CORRETA (agora os items existem no banco!)
  SELECT STRING_AGG(
    CASE 
  ...
  -- MARCAR COMO ENVIADO após chamar notify_event
