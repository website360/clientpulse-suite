...
DROP POLICY IF EXISTS "Admins can manage ticket WhatsApp templates" ON public.ticket_whatsapp_templates;
...
DROP TRIGGER IF EXISTS update_ticket_whatsapp_templates_updated_at ON public.ticket_whatsapp_templates;
