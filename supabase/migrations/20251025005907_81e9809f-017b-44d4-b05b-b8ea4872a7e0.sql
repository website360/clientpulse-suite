-- Atualizar função check_expiring_contracts para usar responsible_name
    ...
    IF days_until_expiry IN (30, 15, 7, 3, 1) THEN
      IF NOT EXISTS (
        ...
        SELECT 
          ...
          'O contrato de ' || COALESCE(contract_record.responsible_name, contract_record.company_name, contract_record.client_name) || 
...
-- Atualizar função check_expiring_domains para usar responsible_name
    ...
    IF days_until_expiry IN (30, 15, 7, 3, 1) THEN
      IF NOT EXISTS (
        ...
        SELECT 
          ...
          COALESCE(domain_record.responsible_name, domain_record.company_name, domain_record.client_name) || 
